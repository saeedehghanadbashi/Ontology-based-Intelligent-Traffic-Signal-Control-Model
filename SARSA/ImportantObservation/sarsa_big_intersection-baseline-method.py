...
if __name__ == '__main__':
    ...
    out_csv = 'SARSA/ImportantObservation/Important-Observation-SARSA-output-BASELINE-run1.csv' #+ experiment_time*
    ...
    env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                          ...
                          max_green=100,
                          max_depart_delay=0,
                          tripinfo_output='SARSA/ImportantObservation/Important-Observation-SARSA-tripinfo-BASELINE-run1.xml',
...
#new added ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
            ...
            outfile = open('SARSA/ImportantObservation/Important-Observation-SARSA-result-BASELINE-run1.csv','w')
