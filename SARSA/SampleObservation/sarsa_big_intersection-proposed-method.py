...
if __name__ == '__main__':
    ...
    out_csv = 'SARSA/SampleObservation/Sample-Observation-SARSA-output-OUR-ALGORITHM-run1.csv' #+ experiment_time*
    ...
    env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                          ...
                          max_green=100,
                          max_depart_delay=0,
                          tripinfo_output='SARSA/SampleObservation/Sample-Observation-SARSA-tripinfo-OUR-ALGORITHM-run1.xml',
...
#new added ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
            ...
            outfile = open('SARSA/SampleObservation/Sample-Observation-SARSA-result-OUR-ALGORITHM-run1.csv','w')
