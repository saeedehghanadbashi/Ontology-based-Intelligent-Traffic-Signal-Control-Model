...
#new added ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        ...
        if self.counter % 2 == 0 and self.ambulance_count_0to1 < 5:
        ...
        if self.counter % 2 != 0: self.ambulance_count_0to1 = 0
        '''
...
#new added ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        ...
        if self.single_agent:
            ...
            return   importance_weight_list, test_keep_list, test_give_up_list, distance_reward, distance_val_per_road, ambulance_lane_list, trailer_lane_list, fueltruck_lane_list, self.neighbors_list, time_on_phase_list, phase_id_list, self.counter, veh_position_data, veh_waiting_time, veh_complete_data, observation, reward, done, {}
