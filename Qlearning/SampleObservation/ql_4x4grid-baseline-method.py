...
if __name__ == '__main__':
    ...
    out_csv = 'Qlearning/SampleObservation/Sample-Observation-Qlearning-output-BASELINE-run1.csv'.format(alpha, gamma, decay)
    ...
    env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                          ...
                          max_depart_delay=0,
                          tripinfo_output='Qlearning/SampleObservation/Sample-Observation-Qlearning-tripinfo-BASELINE-run1.xml',
                          phases=[
    ...
    for run in range(1, runs+4):
        ...
        outfile = open('Qlearning/SampleObservation/Sample-Observation-Qlearning-result-BASELINE-run1.csv','w')
