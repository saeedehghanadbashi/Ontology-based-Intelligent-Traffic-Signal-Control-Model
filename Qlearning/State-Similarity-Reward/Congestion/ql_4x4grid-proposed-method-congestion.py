...
if __name__ == '__main__':
    ...
    out_csv = 'Qlearning/State-Similarity-Reward/State-Similarity-Reward-Qlearning-output-OUR-ALGORITHM-run1.csv'.format(alpha, gamma, decay)
    ...
    env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                          ...
                          max_depart_delay=0,
                          tripinfo_output='Qlearning/State-Similarity-Reward/State-Similarity-Reward-Qlearning-tripinfo-OUR-ALGORITHM-run1.xml',
                          phases=[
    ...
    for run in range(1, runs+4):
                ...
                for agent_id in ql_agents.keys():
                    if flag_pre != 'None': 
                        if flag_pre[agent_id] != -1:
                            actions[agent_id] = flag_pre[agent_id]
        ...
        outfile = open('Qlearning/State-Similarity-Reward/State-Similarity-Reward-Qlearning-result-OUR-ALGORITHM-run1.csv','w')
