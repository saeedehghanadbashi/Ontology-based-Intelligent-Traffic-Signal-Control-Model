...
if __name__ == '__main__':
    ...
    out_csv = 'Qlearning/ImplicitObservation/Implicit-Observation-Qlearning-output-OUR_ALGORITHM-run1.csv'.format(alpha, gamma, decay)
    ...
    env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                          ...
                          max_depart_delay=0,
                          tripinfo_output='Qlearning/ImplicitObservation/Implicit-Observation-Qlearning-tripinfo-OUR-ALGORITHM-run1.xml',
                          phases=[
    ...
    for run in range(1, runs+4):
        ...
        outfile = open('Qlearning/ImplicitObservation/Implicit-Observation-Qlearning-result-OUR-ALGORITHM-run1.csv','w')
