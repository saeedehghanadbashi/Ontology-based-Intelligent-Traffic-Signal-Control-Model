...
from DQN.dqnp1congestion import DQN

env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                        single_agent=False,
                        route_file='nets/4x4-Saeedeh/4x4c1c2c1c2.rou.xml',
                        out_csv_name='DQN/State-Similarity-Reward/State-Similarity-Reward-Scenario2-DQN-output-OUR-ALGORITHM-run1.csv',
                        use_gui=False,
                        num_seconds=1000,
                        yellow_time=4,
                        min_green=5,
                        max_green=100,
                        max_depart_delay=0,
                        tripinfo_output='DQN/State-Similarity-Reward/State-Similarity-Reward-Scenario2-DQN-tripinfo-OUR-ALGORITHM-run1.xml',
