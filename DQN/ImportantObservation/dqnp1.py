...
#new added ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
                ...
                if step_num_pre != 'None' and minute_time % 2 == 0:
                    for agent_id in range(0,16):
                        ...
                        if flag_pre != 'None': action[str(agent_id)] = flag_pre[str(agent_id)]
                        else: action[str(agent_id)] = random.randint(0, 1)
                #'''Selecting part-uncertainty
...
#new added ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
            ...
            outfile = open('DQN/ImportantObservation/Important-Observation-DQN-result-OUR-ALGORITHM-run1.csv','w')
