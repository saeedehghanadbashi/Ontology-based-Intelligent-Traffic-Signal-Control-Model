...
env = SumoEnvironment(net_file='nets/4x4-Saeedeh/4x4.net.xml',
                        ...
                        out_csv_name='DQN/ImplicitObservation/Implicit-Observation-DQN-output-OUR-ALGORITHM-run1.csv',
                        use_gui=False,
                        num_seconds=1000,
                        yellow_time=4,
                        min_green=5,
                        max_green=100,
                        max_depart_delay=0,
                        tripinfo_output='DQN/ImplicitObservation/Implicit-Observation-DQN-tripinfo-OUR-ALGORITHM-run1.xml',
